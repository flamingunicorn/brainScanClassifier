...
def convert_dcm_to_png(dcm_file, output_dir, index):
    ...
    image_path = os.path.join(output_dir, f"a_scan{index}.png")
...
input_folder = "images/ADNI/002_S_0295/Axial_PD_T2_FSE/2006-04-18_08_38_08.0/I13723" # Update with the path to your input folder containing DICOM files
